const CACHE_NAME='homes20-v51';
const ASSETS=[
  './','./index.html','./styles.css?v=51','./app.js?v=51','./supabase-config.js?v=51','./manifest.webmanifest',
...
self.addEventListener('fetch',event=>{
  ...
  const isCore=url.origin===self.location.origin && (url.pathname.endsWith('/')||url.pathname.endsWith('/index.html')||url.pathname.endsWith('/app.js')||url.pathname.endsWith('/styles.css')||url.pathname.endsWith('/supabase-config.js'));
  if(isCore){
