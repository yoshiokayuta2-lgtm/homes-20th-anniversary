...
self.addEventListener('fetch',event=>{
  ...
  const freshFirst = url.pathname.endsWith('/') || url.pathname.endsWith('/index.html') || url.pathname.endsWith('/app.js') || url.pathname.endsWith('/styles.css') || url.pathname.endsWith('/supabase-config.js') || url.pathname.endsWith('/history-data.js');
  if(freshFirst){
