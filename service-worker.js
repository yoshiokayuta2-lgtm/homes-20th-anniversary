const CACHE_NAME='homes20-v5141';
const ASSETS=[
...
self.addEventListener('fetch',event=>{
  ...
  const freshFirst = url.pathname.endsWith('/') || url.pathname.endsWith('/index.html') || url.pathname.endsWith('/app.js') || url.pathname.endsWith('/styles.css') || url.pathname.endsWith('/supabase-config.js') || url.pathname.endsWith('/history-data.js') || url.pathname.endsWith('/admin.html') || url.pathname.endsWith('/ride-admin.html');
  if(freshFirst){
